class OrderAddress
  ...
  def save
    ...
    Address.create(buying_history_id: buying_history_id, postal_code: postal_code, municipality: municipality, address: address, building: building, phone_number: phone_number)
  end
end